...
def upgrade() -> None:
    ...
    op.execute('ALTER TABLE category RENAME CONSTRAINT name_length_check TO category_name_length_check')
    op.execute('ALTER TABLE category RENAME CONSTRAINT slug_length_check TO category_slug_length_check')
...
def downgrade() -> None:
    ...
    op.execute('ALTER TABLE category RENAME CONSTRAINT category_name_length_check TO name_length_check')
    op.execute('ALTER TABLE category RENAME CONSTRAINT category_slug_length_check TO slug_length_check')
