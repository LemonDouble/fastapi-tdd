...
def upgrade() -> None:
    ...
    op.add_column('seasonal_event', sa.Column('start_date', sa.DateTime(), nullable=False))
    op.add_column('seasonal_event', sa.Column('end_date', sa.DateTime(), nullable=False))
    op.add_column('seasonal_event', sa.Column('name', sa.String(length=100), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_constraint('seasonal_event_name_length_check', 'seasonal_event', type_='check')
